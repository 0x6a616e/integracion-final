<script>
    ...
    onMount(async () => {
        ...
        let attrs = await getFunction('http://34.70.30.227:5000/attr/branch');
        let values = await getFunction('http://34.70.30.227:5000/data/branch/id/'+params.id);
...
<DetallesItem tipo = "Sucursal" tables = {table}/>
